...
class FaceProc(object):
    ...
    def __init__(self):
        ...
        self.landmark_estimatior= dlib.shape_predictor(
                                    "Headpose_forensic/models/shape_predictor_68_face_landmarks.dat")
        self.face_detector = dlib.get_frontal_face_detector()

    def get_all_face_rects(self, img):
        # 对图像做预处理，使原本OpenCV的图片格式BGR变成RGB
        img_rgb = img[:, :, (2 ,1, 0)]
    ...
    def get_landmarks_all_faces(self, img, rect):
        all_landmarks = []
        img_rgb = img[:, :, (2, 1, 0)]
